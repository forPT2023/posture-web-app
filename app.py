...
if clear_images and os.path.exists(os.path.join(save_path, "before.png")) and os.path.exists(os.path.join(save_path, "after.png")):
...
with col1:
    if st.button("📸 ビフォーを撮影"):
        ...
        if frame is not None:
            ...
            st.warning("フレームが取得できませんでした。カメラを確認してください。")
